...
## Project Structure
    ...
    ├── commercial_job_trac_38536  # Django project configurations
...
1. Clone this repo and `cd commercial_job_trac_38536`
...
2. Clone this repo and `cd commercial_job_trac_38536`
